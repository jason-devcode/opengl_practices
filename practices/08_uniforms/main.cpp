...
void render_loop( GLFWwindow* window ) {
  ...
  GLuint brightnessLocation = glGetUniformLocation( shader.program, "brightness" );
  ...
  while ( not glfwWindowShouldClose( window ) ) {
    ...
    glUniform1f( brightnessLocation, static_cast<float>(std::sin( fluctuation ) / 2 + 0.5) );
